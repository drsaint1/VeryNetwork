...
contract VeryTournaments is Ownable, ReentrancyGuard, Pausable {
    struct Tournament {
        uint256 id;
        string name;
        uint256 entryFee;
    ...
    IVeryRacing public racingContract;
    ...
    constructor(address _racingContract) Ownable(msg.sender) {
        racingContract = IVeryRacing(_racingContract);
    }
    ...
    function enterTournament(uint256 tournamentId, uint256 carId) external payable whenNotPaused {
        ...
        IVeryRacing.RaceCar memory car = racingContract.getCarDetails(carId);
    ...
    function breedCars(uint256 parent1Id, uint256 parent2Id) external payable whenNotPaused {
        ...
        IVeryRacing.RaceCar memory parent1 = racingContract.getCarDetails(parent1Id);
        IVeryRacing.RaceCar memory parent2 = racingContract.getCarDetails(parent2Id);
