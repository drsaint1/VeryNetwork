      ...
      >
                ...
                >
                  ...
                  >
                    {carAvailabilityLoading
                      ...
                      : playerCars.length === 0
                      ? "No vehicles available - mint a vehicle first"
                      : `${playerCars.length} vehicle(s) staked - unstake to join tournaments`}
                  </span>
                </div>
              </div>
            )}
        ...
        {!isConnected ? (
          ...
          >
            ...
            >
              Checking your vehicle availability and tournament status
            </p>
          </div>
        ) : !availableCarId ? (
          <div
          ...
          >
            ...
            >
              {playerCars.length === 0
                ? "You need a racing vehicle to join tournaments"
                : "All your vehicles are staked and unavailable for tournaments"}
            </p>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "14px" }}>
              {playerCars.length === 0
                ? "Go back to main menu and mint a vehicle first"
                : `You have ${playerCars.length} vehicle(s), but they're all staked. Please unstake a vehicle from your garage to join tournaments.`}
            </p>
          </div>
        ) : (
          <>
